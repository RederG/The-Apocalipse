...
After that, in the terminal, create the "build" folder. Then write the command and execute it (the last instruction -I"{path_to_SFML_include_files(like D:/SFML-3.0.2/include)}" is important, you must put the absolute path to the include files of SFML) :
